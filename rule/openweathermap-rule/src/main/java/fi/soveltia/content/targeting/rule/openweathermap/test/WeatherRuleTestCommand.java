...
@Component(
		...
		property = {
				...
				"mvc.command.name=" + ResourceRequestKeys.WEATHER_RULE_TEST
		},
		service = MVCResourceCommand.class
)
public class WeatherRuleTestCommand implements MVCResourceCommand {
		...
		throws PortletException {
			...
			String userWeather = ParamUtil.getString(resourceRequest, ContextKeys.WEATHER);
			...
			String weather = provider.getWeather();
			response.put("result", userWeather.equals(weather));
		...
		private static final Log _log = LogFactoryUtil.getLog(WeatherRuleTestCommand.class);
}
